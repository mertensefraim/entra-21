...
namespace Entra21.BancoDados01.Ado.Net.Services
{
    internal class PersonagemService : IPersonagemService
    {
        public void Apagar(int id)
        {
            ...
            // Substituir os @ no comando da query que será executada no banco de dados, previnindo SQL Injection
        ...
        public void Editar(Personagem personagem)
        {
            ...
            // Executa o comando de update na tabela personagens
            comando.ExecuteNonQuery();
        ...
        public Personagem ObterPorId(int id)
        {
            ...
            // Carregar todos os registro dataTable
