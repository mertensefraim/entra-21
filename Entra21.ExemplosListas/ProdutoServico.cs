namespace Entra21.ExemplosListas
{
    internal class ProdutoServico
    {
        ...
        public Produto ObterMenorPrecoUnitario()
        {
            ...
            // Percorre a lista de produtos para obter o produto com o menor preço
            for (int i = 0; i < produtos.Count; i++)
            {
                // Obtém o produto atual da lista que está sendo percorrida
                Produto produto = produtos[i];

                // Verifica se o produto atul possuí o menor preço unitário
        ...
        public List<double> ObterTodosPrecos()
        {
            ...
            for (int i = 0; i < produtos.Count; i++)
            {
                ...
                // Adicionar o preço total na lista de preços
        ...
        public double ObterMediaPrecosTotais()
        {
            ...
            for (int i = 0; i < produtos.Count; i++)
            {
                ...
                // Adiciona o preço total do produto na variável soma de preço totais
                somaPrecosTotais += produto.CalcularPrecoTotal();
            }

            // Calcula a média de acorcdo com a quantidade de produtos
