    ...
    internal class Exercicio13
    {
        public void Executar()
        {
            ...
            int quantidadeHomens = 0, quantidadeMulheres = 0, quantidadeCartoesVermelhosMenor = int.MaxValue, quantidadeCartoesAmarelosMenor = int.MaxValue,
                quantidadeCartoesVermelhosMaior = int.MinValue, quantidadeCartoesAmarelosMaior = int.MinValue, maiorNome = int.MinValue, menorNome = int.MaxValue;
            ...
            while (indice < 3)
            {
                ...
                if(pesoJogador <= menorPeso)
                {
                    if (pesoJogador == menorPeso)
                    {
                        pesoJogador = pesoJogador + ", " + nomeJogador;
                    }
                    else
                    {
                        pesoJogador = nomeJogador;
                    }
