...
INSERT INTO pessoas(nome, cpf, rg, data_de_nascimento, idade)
	...
	'5.103.578-9', '1985-03-11', 33);

INSERT INTO pessoas(nome, cpf, rg, data_de_nascimento, idade)
	VALUES ('Bryan Caio Lopes', '213.217.201-30', 
	'12.949.454-9', '1970-06-18', 48);

SELECT id, nome, cpf, rg, FORMAT(data_de_nascimento, 'dd/MM/yyyy') AS 'Data de nascimento', idade FROM pessoas;